...
#  if pytz.utc.localize(parse('2014-10-1')) < parse(game['scheduled']) and parse(game['scheduled']) < pytz.utc.localize(parse('2014-12-1')):
  if pytz.utc.localize(parse('2014-11-18')) < parse(game['scheduled']) and parse(game['scheduled']) < pytz.utc.localize(parse('2014-12-1')):
...
print str(myhome) + " : " + str(johnnyhome) + " / " + str(games)
